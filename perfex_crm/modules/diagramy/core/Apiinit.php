...
class Apiinit
{
    ...
    {
        get_instance()->load->library('diagramy_aeiou');
        $module = get_instance()->app_modules->get($module_name);
        if (empty($code)) {
        ...
        $envato_res = get_instance()->diagramy_aeiou->getPurchaseData($code);
        ...
        try {
            ...
            $response = Diagramy_Requests::post(REG_PROD_POINT, ['Accept' => 'application/json'], $data);
